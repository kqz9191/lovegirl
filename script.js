document.addEventListener("DOMContentLoaded", () => {
    ...
    const textToType = "каждый день с тобой это самый приятный момент, который мне очень приятный. ты делаешь меня самым счастливым человеком, и в этот можно сказать твой праздник я хочу напомнить тебе, что ты мое самое ценное,что есть. спасибо за твою любовь, поддержку и тепло. с 8 марта, моя любимая девочка 🌸✨";
